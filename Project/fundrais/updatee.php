    ...
    <div class="collapse collapse-horizontal rounded-end-5 sticky-top z-1 h100vh" id="collapseWidthExample">
      <nav class="w250px h100vh bg-dark p-2 rounded-end-5 ">
        ...
        <div>
          ...
          <p class="text-white text-center my-2 fs-4">Pikapika</p>
          ...
          <form action="./doUpdate01.php" method="post" enctype="multipart/form-data">
            ...
            <div class="input-group">
                ...
                <div class="input-group mt-1 mb-1">
                    ...
                    <input name="productsdate" type="date" class="form-control" id="productsdate" value="<?= date("Y-m-d", strtotime($row["productsCreateAt"])) ?>">
                </div>
